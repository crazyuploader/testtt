...
ANYKERNEL_DIR="$(cd ..)/AnyKernel3"
ZIP_NAME="perf"

export KBUILD_BUILD_USER="jungle"
export KBUILD_BUILD_HOST="ryzen"

export CROSS_COMPILE="$(cd ..)/aarch64-buildroot-linux-musl/bin/aarch64-buildroot-linux-musl-"
export CROSS_COMPILE_ARM32="$(cd ..)/arm-eabi-4.8/bin/arm-eabi-"
